...
{
    public class Level17 : IAIBehavior
    {
        ...
        private static AIBehavior GetBehavior()
        {
            return new AIBehavior()
            {
                ...
                {
                    new(AIRoutineType.CreateEnemyInCircle, 4900, 7, 20),
                    new(AIRoutineType.CreateEnemyRandomPos, 700, 1, 4),
                    new(AIRoutineType.CreateMeteor, 500, 1, 2, 0.25f),
                    new(AIRoutineType.CreateEnemyInLine, 4000, 5, 10, 0.45f)
                }
            };
        }
    }
