...
{
    public class Level20 : IAIBehavior
    {
        ...
        private static AIBehavior GetBehavior()
        {
            return new AIBehavior()
            {
                ...
                NumberOfRandomTasksToPerform = 100,
                ...
                {
                    new(AIRoutineType.CreateEnemyInCircle, 4000, 7, 20),
                    new(AIRoutineType.CreateEnemyRandomPos, 400, 1, 4),
                    new(AIRoutineType.CreateMeteor, 300, 1, 2, 0.25f),
                    new(AIRoutineType.CreateEnemyInLine, 2000, 4, 12, 0.45f)
                }
            };
        }
    }
