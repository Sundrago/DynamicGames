...
namespace Lofelt.NiceVibrations
{
    ...
    public static class HapticPatterns
    {
        ...
        private static float[] constantPatternTime = { 0.0f, 0.0f };
        ...
        static HapticPatterns()
        {
            ...
            Selection = new Preset(PresetType.Selection, new[] { 0.0f, 0.04f },
                new[] { 0.471f, 0.471f });

            Light = new Preset(PresetType.LightImpact, new[] { 0.000f, 0.040f },
                new[] { 0.156f, 0.156f });

            Medium = new Preset(PresetType.MediumImpact, new[] { 0.000f, 0.080f },
                new[] { 0.471f, 0.471f });

            Heavy = new Preset(PresetType.HeavyImpact, new[] { 0.0f, 0.16f },
                new[] { 1.0f, 1.00f });

            Rigid = new Preset(PresetType.RigidImpact, new[] { 0.0f, 0.04f },
                new[] { 1.0f, 1.00f });

            Soft = new Preset(PresetType.SoftImpact, new[] { 0.000f, 0.160f },
                new[] { 0.156f, 0.156f });

            Success = new Preset(PresetType.Success, new[] { 0.0f, 0.040f, 0.080f, 0.240f },
                new[] { 0.0f, 0.157f, 0.000f, 1.000f });

            Failure = new Preset(PresetType.Failure,
                new[] { 0.0f, 0.080f, 0.120f, 0.200f, 0.240f, 0.400f, 0.440f, 0.480f },
                new[] { 0.0f, 0.470f, 0.000f, 0.470f, 0.000f, 1.000f, 0.000f, 0.157f });

            Warning = new Preset(PresetType.Warning, new[] { 0.0f, 0.120f, 0.240f, 0.280f },
                new[] { 0.0f, 1.000f, 0.000f, 0.470f });
        }
        ...
        public static void PlayEmphasis(float amplitude, float frequency)
        {
            ...
            if (HapticController.Init() || GamepadRumbler.IsConnected())
            {
                ...
                HapticController.Load(Encoding.UTF8.GetBytes(json), rumble);
        ...
        private static PresetType presetTypeForEmphasis(float amplitude)
        {
            ...
            if (amplitude <= 0.5f && amplitude > 0.3)
        ...
        ///     <li>
        ///         On Android, it will play a pattern with maximum amplitude for the set <c>duration</c>
        ///         since there is no amplitude control.
        ///     </li>
        /// </ul>
        ...
        public static void PlayConstant(float amplitude, float frequency, float duration)
        {
            ...
            const int rumbleEntryDurationMs =
 16; // One rumble entry per frame at 60 FPS, which is the limit of what GamepadRumbler can play
        ...
        /// - On Android devices that can play
        /// <c>.haptic</c>
        /// clips (DeviceCapabilities.meetsAdvancedRequirements
        /// is
        /// <c>true</c>
        /// ) and on gamepads, this function plays a haptic pattern that has a similar
        /// experience to the matching iOS system haptics.
        /// - On Android devices that can not play
        /// <c>.haptic</c>
        /// clips (DeviceCapabilities.meetsAdvancedRequirements
        /// is
        /// <c>false</c>
        /// ), this function plays a haptic pattern that has a similar experience to
        ...
        private struct Pattern
        {
            ...
            public GamepadRumble ToRumble()
            {
                ...
                if (time.Length <= 1) return result;
                ...
                {
                    var patternDurationMs = (int)((time[rumbleIndex + 1] - time[rumbleIndex]) * 1000.0f);
            ...
            public string ToClip()
            {
                ...
                {
                    var clampedAmplitude = Mathf.Clamp(amplitude[i], 0.0f, 1.0f);
