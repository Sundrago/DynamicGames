...
namespace Lofelt.NiceVibrations
{
    ...
    /// </summary>
    /// HapticController allows you to load and play
    /// <c>.haptic</c>
    /// clips, and
    ...
    /// If you need a
    /// <c>MonoBehaviour</c>
    /// API, use HapticSource and
    /// HapticReceiver instead.
    /// 
    /// On iOS and Android, the device is vibrated, using
    /// <c>LofeltHaptics</c>
    /// .
    ...
    public static class HapticController
    {
        ...
        /// </summary>
        public static HapticPatterns.PresetType fallbackPreset { get; set; } = HapticPatterns.PresetType.None;
        ...
        /// 
        /// \ref outputLevel is a multiplication factor, it is
        /// <i>not</i>
        /// a dB value. The factor needs to be
        /// 0 or greater.
        /// 
        ...
        /// 
        /// \ref clipLevel is a multiplication factor, it is
        /// <i>not</i>
        /// a dB value. The factor needs to be
        /// 0 or greater.
        /// 
        ...
        public static bool Init()
        {
            if (!lofeltHapticsInitalized)
            {
                ...
                playbackFinishedTimer.Elapsed += (obj, args) =>
                {
        ...
        /// <param name="data">
        ///     The haptic clip, which is the content of the
        ...
        /// runtime.
        /// <param name="json">
        ///     The haptic clip, which is the content of the <c>.haptic</c> file,
        ///     a UTF-8 encoded JSON string without a null terminator
        /// </param>
        ...
        /// If
        /// <c>Loop(true)</c>
        /// was called previously, the playback will be repeated
        /// until Stop() is called. Otherwise the haptic clip will only play once.
        /// 
        /// In case the device does not meet the requirements to play
        /// <c>.haptic</c>
        /// clips, this
        ...
        /// <param name="time">
        ///     The new position within the clip, as seconds from the beginning
        ///     of the clip
        /// </param>
        ...
        /// <param name="enabled">
        ///     If the value is <c>true</c>, looping will be enabled which results
        ///     in repeating the playback until Stop() is called; if <c>false</c>, the haptic
        ///     clip will only be played once.
        /// </param>
