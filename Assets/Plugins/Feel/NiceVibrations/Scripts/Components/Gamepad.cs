...
namespace Lofelt.NiceVibrations
{
    ...
    public static class GamepadRumbler
    {
        ...
        /// 
        /// If this method isn't called, haptics will be played on
        /// <c>InputSystem.Gamepad.current</c>
        ...
        /// 
        /// If the
        /// <c>NICE_VIBRATIONS_DISABLE_GAMEPAD_SUPPORT</c>
        /// define is set in the player settings,
 ...
 loadedRumble.lowFrequencyMotorSpeeds[rumbleIndex] * Mathf.Max(lowFrequencyMotorSpeedMultiplication, 0.0f);
            float highFrequencySpeed =
 loadedRumble.highFrequencyMotorSpeeds[rumbleIndex] * Mathf.Max(highFrequencyMotorSpeedMultiplication, 0.0f);
