...
public class IronSourceInterstitialEvents : MonoBehaviour
{
 ...
 new IronSourceInterstitialLevelPlayAndroid();//sets this.IronSourceInterstitialLevelPlayAndroid as listener for Interstitia(Mediation& Demand Only) events in the bridge
