public static class IronSourceConstants
{
    ...
    //Bridge Classes
    public const string interstitialBridgeListenerClass =
        "com.ironsource.unity.androidbridge.UnityInterstitialListener";

    public const string LevelPlayinterstitialBridgeListenerClass =
        "com.ironsource.unity.androidbridge.UnityLevelPlayInterstitialListener";

    public const string rewardedVideoBridgeListenerClass =
        "com.ironsource.unity.androidbridge.UnityRewardedVideoListener";

    public const string rewardedVideoManualBridgeListenerClass =
        "com.ironsource.unity.androidbridge.UnityRewardedVideoManualListener";

    public const string LevelPlayRewardedVideoBridgeListenerClass =
        "com.ironsource.unity.androidbridge.UnityLevelPlayRewardedVideoListener";

    public const string LevelPlayRewardedVideoManualBridgeListenerClass =
        "com.ironsource.unity.androidbridge.UnityLevelPlayRewardedVideoManualListener";
    ...
    public const string LevelPlaybannerBridgeListenerClass =
        "com.ironsource.unity.androidbridge.UnityLevelPlayBannerListener";

    public const string segmentBridgeListenerClass = "com.ironsource.unity.androidbridge.UnitySegmentListener";

    public const string impressionDataBridgeListenerClass =
        "com.ironsource.unity.androidbridge.UnityImpressionDataListener";

    public const string initializeBridgeListenerClass =
        "com.ironsource.unity.androidbridge.UnityInitializationListener";
