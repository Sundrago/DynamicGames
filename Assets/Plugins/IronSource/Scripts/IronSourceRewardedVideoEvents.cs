...
public class IronSourceRewardedVideoEvents : MonoBehaviour
{
 ...
 new IronSourceRewardedVideoLevelPlayAndroid();//sets this.IronSourceRewardedVideoLevelPlayAndroid as listener for RV events in the bridge
    ...
    public void onAdShowFailed(string args)
    {
        if (_onAdShowFailedEvent != null)
        {
            ...
            var err = getErrorFromErrorObject(argList[0]);
            var adInfo = new IronSourceAdInfo(argList[1].ToString());
    ...
    public void onAdOpened(string args)
    {
        ...
        {
            var adInfo = new IronSourceAdInfo(args);
    ...
    public void onAdRewarded(string args)
    {
        ...
        {
            var argList = Json.Deserialize(args) as List<object>;
            var ssp = getPlacementFromObject(argList[0]);
            var adInfo = new IronSourceAdInfo(argList[1].ToString());
    ...
    {
        if (_onAdUnavailableEvent != null) _onAdUnavailableEvent();
    }
    ...
    public void onAdReady(string adinfo)
    {
        ...
        {
            var adInfo = new IronSourceAdInfo(adinfo);
    ...
    private IronSourceError getErrorFromErrorObject(object descriptionObject)
    {
        ...
        {
            var eCode = Convert.ToInt32(error[IronSourceConstants.ERROR_CODE].ToString());
            var eDescription = error[IronSourceConstants.ERROR_DESCRIPTION].ToString();
