...
public class IronSourceEvents : MonoBehaviour
{
    ...
    private delegate void ISUnityBackgroundCallback(string args);
...
#pragma warning disable CS0067
    ...
    private void Awake()
    {
        ...
        initializationAndroid =
 new IronSourceInitializationAndroid();//sets this.initialztionAndroid as listener for initialztionAndroid events in the bridge
        registerInitializationEvents(); //subscribe to initialization events from this.initializationAndroid
        rewardedVideoAndroid =
 new IronSourceRewardedVideoAndroid();//sets this.rewardedVideoAndroid as listener for RV(Mediation& Demand Only) events in the bridge
        ...
        interstitialAndroid =
 new IronSourceInterstitialAndroid();//sets this.interstitialAndroid as listener for Interstitia(Mediation& Demand Only) events in the bridge
        ...
        offerwallAndroid =
 new IronSourceOfferwallAndroid();//sets this.offerwallAndroid as listener for Offerwall(Mediation& Demand Only) events in the bridge
        registerOfferwallEvents();//subscribe to Offerwall events from this.offerwallAndroid
        bannerAndroid =
 new IronSourceBannerAndroid();//sets this.bannerAndroid as listener for Banner(Mediation& Demand Only) events in the bridge
        registerBannerEvents();//subscribe to Banner events from this.bannerAndroid
        impressionDataAndroid =
 new IronSourceImpressionDataAndroid();//sets this.impressionDataAndroid as listener for Impression Data events in the bridge
        registerImpressionDataEvents();//subscribe to onImpressionSuccess event from this.impressionDataAndroid
        segmentAndroid =
 new IronSourceSegmentAndroid();//sets this.segmentAndroid as listener for Segment events in the bridge
    ...
    [MonoPInvokeCallback(typeof(ISUnityBackgroundCallback))]
    public static void FireCallback(string args)
    {
        if (onImpressionDataReadyEvent != null) InvokeEvent(onImpressionDataReadyEvent, args);
    }
#endif
    ...
    public static event Action onSdkInitializationCompletedEvent
    {
        add
        {
            if (_onSdkInitializationCompletedEvent == null ||
                !_onSdkInitializationCompletedEvent.GetInvocationList().Contains(value))
    ...
    {
        if (_onSdkInitializationCompletedEvent != null) _onSdkInitializationCompletedEvent();
    }
    ...
    [Obsolete(
        "This API has been deprecated as of SDK 7.3.0. Please use the alternate API in IronSourceRewardedVideoEvents listener instead.",
        false)]
    public static event Action<IronSourceError> onRewardedVideoAdShowFailedEvent
    {
        add
    ...
    public void onRewardedVideoAdShowFailed(string description)
    {
        if (_onRewardedVideoAdShowFailedEvent != null)
        {
            var sse = getErrorFromErrorObject(description);
    ...
    public static event Action onRewardedVideoAdEndedEvent
    {
        ...
        {
            if (_onRewardedVideoAdEndedEvent != null &&
                _onRewardedVideoAdEndedEvent.GetInvocationList().Contains(value)) _onRewardedVideoAdEndedEvent -= value;
        }
    }
    ...
    public void onRewardedVideoAdRewarded(string description)
    {
        if (_onRewardedVideoAdRewardedEvent != null)
        {
            var ssp = getPlacementFromObject(description);
    ...
    {
        var isAvailable = stringAvailable == "true" ? true : false;
        if (_onRewardedVideoAvailabilityChangedEvent != null)
    ...
    public static event Action<string> onRewardedVideoAdLoadedDemandOnlyEvent
    {
        add
        {
            if (_onRewardedVideoAdLoadedDemandOnlyEvent == null ||
                !_onRewardedVideoAdLoadedDemandOnlyEvent.GetInvocationList().Contains(value))
    ...
    {
        if (_onRewardedVideoAdLoadedDemandOnlyEvent != null) _onRewardedVideoAdLoadedDemandOnlyEvent(instanceId);
    }
    ...
    public static event Action<string, IronSourceError> onRewardedVideoAdLoadFailedDemandOnlyEvent
    {
        add
        {
            if (_onRewardedVideoAdLoadFailedDemandOnlyEvent == null ||
                !_onRewardedVideoAdLoadFailedDemandOnlyEvent.GetInvocationList().Contains(value))
    ...
    public void onRewardedVideoAdLoadFailedDemandOnly(string args)
    {
        ...
        {
            var argList = Json.Deserialize(args) as List<object>;
            var err = getErrorFromErrorObject(argList[1]);
            var instanceId = argList[0].ToString();
    ...
    {
        if (_onRewardedVideoAdRewardedDemandOnlyEvent != null) _onRewardedVideoAdRewardedDemandOnlyEvent(instanceId);
    }
    ...
    {
        if (_onRewardedVideoAdClickedDemandOnlyEvent != null) _onRewardedVideoAdClickedDemandOnlyEvent(instanceId);
    }
    ...
    [Obsolete(
        "This API has been deprecated as of SDK 7.3.0. Please use the alternate API in IronSourceInterstitialEvents listener instead.",
        false)]
    public static event Action onInterstitialAdReadyEvent
    {
        add
    ...
    public static event Action onInterstitialAdOpenedEvent
    {
        ...
        {
            if (_onInterstitialAdOpenedEvent != null &&
                _onInterstitialAdOpenedEvent.GetInvocationList().Contains(value)) _onInterstitialAdOpenedEvent -= value;
        }
    }
    ...
    public static event Action onInterstitialAdClosedEvent
    {
        ...
        {
            if (_onInterstitialAdClosedEvent != null &&
                _onInterstitialAdClosedEvent.GetInvocationList().Contains(value)) _onInterstitialAdClosedEvent -= value;
        }
    }
    ...
    public void onInterstitialAdShowFailedDemandOnly(string args)
    {
        ...
        {
            var argList = Json.Deserialize(args) as List<object>;
            var sse = getErrorFromErrorObject(argList[1]);
            var instanceId = argList[0].ToString();
    ...
    [Obsolete(
        "This API call is for the ironSource Offerwall, which will soon be deprecated. Please migrate to the Tapjoy Offerwall using the 'Offerwall migration checklist'.",
        false)]
    public static event Action onOfferwallOpenedEvent
    {
        add
    ...
    [Obsolete(
        "This API has been deprecated as of SDK 7.3.0. Please use the alternate API in IronSourceBannerEvents listener instead.",
        false)]
    public static event Action onBannerAdLoadedEvent
    {
        add
    ...
    {
        var impressionData = new IronSourceImpressionData(args);


        if (_onImpressionSuccessEvent != null) _onImpressionSuccessEvent(impressionData);
    }
    ...
    public static event Action<IronSourceError> onRewardedVideoAdLoadFailedEvent
    {
        add
        {
            if (_onRewardedVideoAdLoadFailedEvent == null ||
                !_onRewardedVideoAdLoadFailedEvent.GetInvocationList().Contains(value))
    ...
    public static event Action onRewardedVideoAdReadyEvent
    {
        add
        {
            if (_onRewardedVideoAdReadyEvent == null ||
                !_onRewardedVideoAdReadyEvent.GetInvocationList().Contains(value))
        ...
        {
            if (_onRewardedVideoAdReadyEvent != null &&
                _onRewardedVideoAdReadyEvent.GetInvocationList().Contains(value)) _onRewardedVideoAdReadyEvent -= value;
        }
    }

    public void onRewardedVideoAdReady(string empty)
    {
        if (_onRewardedVideoAdReadyEvent != null) _onRewardedVideoAdReadyEvent();
    }
    ...
    public static event Action<string, IronSourceError> onConsentViewDidFailToLoadWithErrorEvent
    {
        add
        {
            if (_onConsentViewDidFailToLoadWithErrorEvent == null ||
                !_onConsentViewDidFailToLoadWithErrorEvent.GetInvocationList().Contains(value))
    ...
    public void onConsentViewDidFailToLoadWithError(string args)
    {
        if (_onConsentViewDidFailToLoadWithErrorEvent != null && !string.IsNullOrEmpty(args))
        {
            var argList = Json.Deserialize(args) as List<object>;
            var err = getErrorFromErrorObject(argList[1]);
            var consentViewType = argList[0].ToString();
    ...
    public static event Action<string, IronSourceError> onConsentViewDidFailToShowWithErrorEvent
    {
        add
        {
            if (_onConsentViewDidFailToShowWithErrorEvent == null ||
                !_onConsentViewDidFailToShowWithErrorEvent.GetInvocationList().Contains(value))
    ...
    public static event Action<string> onConsentViewDidAcceptEvent
    {
        add
        {
            if (_onConsentViewDidAcceptEvent == null ||
                !_onConsentViewDidAcceptEvent.GetInvocationList().Contains(value))
        ...
        {
            if (_onConsentViewDidAcceptEvent != null &&
                _onConsentViewDidAcceptEvent.GetInvocationList().Contains(value)) _onConsentViewDidAcceptEvent -= value;
        }
    }

    public void onConsentViewDidAccept(string consentViewType)
    {
        if (_onConsentViewDidAcceptEvent != null) _onConsentViewDidAcceptEvent(consentViewType);
    }
    ...
    public static event Action<string> onConsentViewDidDismissEvent
    {
        add
        {
            if (_onConsentViewDidDismissEvent == null ||
                !_onConsentViewDidDismissEvent.GetInvocationList().Contains(value))
    ...
    {
        if (_onConsentViewDidDismissEvent != null) _onConsentViewDidDismissEvent(consentViewType);
    }
    ...
    public static event Action<string> onConsentViewDidLoadSuccessEvent
    {
        add
        {
            if (_onConsentViewDidLoadSuccessEvent == null ||
                !_onConsentViewDidLoadSuccessEvent.GetInvocationList().Contains(value))
    ...
    {
        if (_onConsentViewDidLoadSuccessEvent != null) _onConsentViewDidLoadSuccessEvent(consentViewType);
    }
    ...
    public static event Action<string> onConsentViewDidShowSuccessEvent
    {
        add
        {
            if (_onConsentViewDidShowSuccessEvent == null ||
                !_onConsentViewDidShowSuccessEvent.GetInvocationList().Contains(value))
    ...
    {
        if (_onConsentViewDidShowSuccessEvent != null) _onConsentViewDidShowSuccessEvent(consentViewType);
    }
