...
public class IronSourceInitilizer
{
    ...
    private static void Initilize()
    {
        ...
        if (developerSettings != null)
        {
...
#elif UNITY_IOS
            var appKey = developerSettings.IOSAppKey;
#endif
            ...
            if (developerSettings.EnableAdapterDebug) IronSource.Agent.setAdaptersDebug(true);

            if (developerSettings.EnableIntegrationHelper) IronSource.Agent.validateIntegration();
        }
    }
#endif
}