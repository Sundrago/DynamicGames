public static class IronSourceDependenciesManagerConstants
{
    ...
    //path const
    internal const string IRONSOURCE_SDK_INFO =
        "https://s3.amazonaws.com/ssa.public/Integration-Manager/IronSourceSDKInfo.json";

    internal const string IRONSOURCE_SDK_XML_LINKS =
