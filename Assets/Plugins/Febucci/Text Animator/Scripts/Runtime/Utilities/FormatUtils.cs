...
namespace Febucci.UI.Core
{
    ...
    public static class FormatUtils
    {
        ...
        /// </summary>
        /// <remarks>
        ///     Mostly used in combination with custom typewriter actions. (Manual:
        ///     <see href="https://www.febucci.com/text-animator-unity/docs/writing-custom-actions-c-sharp/">
