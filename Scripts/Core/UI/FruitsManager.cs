...
public class FruitsManager : MonoBehaviour
{
    ...
    public void FruitAnimation(GameObject obj, Transform endPosTransform, float _velocity = 100f, float durationFactor = 1f)
    {
    ...
    private void SetupFruitAnimation(GameObject obj, Vector3[] path, float durationFactor, Transform endPosTransform)
    {
