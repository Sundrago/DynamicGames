...
{
    /// <summary>
    /// Manages the game score and UI elements related to the score.
    /// </summary>
    public class GameScoreManager : SerializedMonoBehaviour
    {
        ...
        [SerializeField] private TextMeshProUGUI score_ui, socre_text_ui, slider_score, slider_high_title, slider_high_score;
