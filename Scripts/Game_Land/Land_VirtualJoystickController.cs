...
/// <summary>
/// Controls a virtual joystick for jumping in a Unity game.
/// </summary>
public class Land_VirtualJoystickController : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler
{
