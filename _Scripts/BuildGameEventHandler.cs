...
public class BuildGameEventHandler : MonoBehaviour
{
    [SerializeField] StageManager stageManager;
    [SerializeField] EndScoreCtrl endScore;
    [SerializeField] GameObject startingPosition;
    [SerializeField] GameObject stageHolderPanel;
    [SerializeField] Light2D deathLight;
    [SerializeField] TextMeshProUGUI currentscore_text, highscore_text, bestscore_text, thisScore_text;
    [SerializeField] GameObject shaker, islandTop, mainCanvas, hearts;
    ...
    public void LoadStage(int idx, bool newGame = false)
    {
        ...
        foreach (GameObject item in stageManager.stages[idx].GetComponent<stage_holder>().items)
        {
    ...
    public void StopHorizonMove()
    {
        ...
        if (surfaceMovement.activeSelf) surfaceMovement.GetComponent<SurfaceMovement2D_2>().LoadSquare();
        falling = true;
    ...
    private void GameFinished()
    {
        ...
        endScore.ShowScore(highScore, GameType.build);
        hearts.GetComponent<HeartsCtrl>().Show(false);
    }
