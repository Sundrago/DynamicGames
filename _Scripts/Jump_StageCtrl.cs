...
public class Jump_StageCtrl : MonoBehaviour
{
    ...
    [SerializeField] GameObject step30, step60, step90, step180, step360;

    [SerializeField] float footstepY_velcoity_max = 1f;
    [SerializeField] float footstepY_velocity_min = 0.1f;
    ...
    public void ShowScore(){
        sfx.PlaySfx(0);
        endScore.ShowScore(score, GameType.jump);
        SetupGame();
    }
